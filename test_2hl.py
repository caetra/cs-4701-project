...
print('hidden neurons 1st layer = '+str(num_neurons))
print('hidden neurons 2nd layer = '+str(num_neurons_2))
import pickle

import numpy as np

import neural_network_2_hidden
...
print('Loaded data')
print('Training neural net, 2 layer')

per = neural_network_2_hidden.NeuralNetwork_2HL(num_attrs, num_neurons, num_neurons_2, 1)
